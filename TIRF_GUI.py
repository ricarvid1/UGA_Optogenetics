...
class Window(QWidget):
    ...
    def setROIHome(self):
        ...
        self.edt_roi_width.setValidator(QIntValidator(0, self.cameraModel.getXSize()))
        self.edt_roi_width.setAlignment(Qt.AlignRight)
        self.edt_roi_width.setMaxLength(4)
        self.edt_roi_width.setText(str(self.cameraModel.getXSize()))
        self.edt_roi_height = QLineEdit()
        self.edt_roi_height.setValidator(QIntValidator(0, self.cameraModel.getYSize()))
        self.edt_roi_height.setAlignment(Qt.AlignRight)
        self.edt_roi_height.setMaxLength(4)
        self.edt_roi_height.setText(str(self.cameraModel.getYSize()))
        # Buttons
