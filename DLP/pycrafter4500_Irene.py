...
#        print('l='+str(longueur))
    ...
    def dispwholefield(self):
        ...
        self.command('w',0xff,0x12,0x03,[int('00000111',2)])
    ...
    def setVideoMode(self):
        # Input source selection command
        # Parallel interface 30 bits is selected
        self.command('w',0xff,0x1a,0x00,[int('00000000',2)])
        # Display Mode Selection Command
        # Video Mode is chosen
        self.command('w',0xff,0x1a,0x1b,[int('00000000',2)])
        
    def enableLEDs(self, rgb):
        rgb.reverse()
        data = ''.join(str(i) for i in rgb)
        data = '00000' + data
        #print data
        # LED Enable Outputs
        self.command('w',0xff,0x1a,0x07,[int(data, 2)])
        
    
    def setPatternMode(self):
        # Input source selection command
        # Image from flash memory is selected
        self.command('w',0xff,0x1a,0x00,[int('00000010',2)])
        # Display Mode Selection Command
